...
def callback(data):
    ...
    if  (child_frame==ar_marker):
        ...
        try:
            ...
            x = translations.x
            y = translations.y
            x_quaternion = quaternion.x
            y_quaternion = quaternion.y
            ndata = data
            ndata.transforms[0].transform.translation.x = -x
            # ndata.transforms[0].transform.translation.y = -y
            # ndata.transforms[0].transform.rotation.x = -x_quaternion
            # ndata.transforms[0].transform.rotation.y = -y_quaternion
